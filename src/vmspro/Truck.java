 ...
 * Specifies the fields related to trucks in the real world, specifically towing
...
public final class Truck extends Vehicle {
     ...
     */
    public Truck(String makeN, String modelN, CarColors colorN, int yearN, String someVIN, double someTow,
            double someCarry) {
     ...
     *            the vin for the car, once set here never changed later
     */
    public Truck(String makeN, String modelN, CarColors colorN, int yearN, String someVIN, Customer someCust,
            double someTow, double someCarry) {
     ...
     * 
     * @param someTowing
     *            the towing capacity of this truck
     ...
     * 
     * @param someCarrying
     *            the amount of carrying capacity
