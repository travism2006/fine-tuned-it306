...
public class DialManageCustomers extends JDialog {
    ...
    private void makeMainPanel(VMSPro app) {
        ...
        addClientBttn.addActionListener(new ActionListener() {
            ...
            private JPanel makeAddCustomerPanel() {
                ...
                String[] opts = { "" };
                JOptionPane.showOptionDialog(null, "", "title", JOptionPane.OK_CANCEL_OPTION,
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (!hold.equals("")) {
                    ...
                    String ans = String.valueOf(JOptionPane.showInputDialog(contentPane, "What type of vehicle:",
                            "Edit Customer", JOptionPane.OK_CANCEL_OPTION, null, opts, opts[0]));
    ...
    /**
     * Given a panel, grabs all required data, validates fields, then creates
     * and returns a customer object. Behaves similar to the <i> Builder</i>
     * design pattern.
     */
