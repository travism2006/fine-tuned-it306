...
public class Vehicle implements VMSPro_Standard_Behavior {
    ...
    /**
     * Verifies that the number is valid and then assigns it the to correct
    ...
    public String toString() {
        String out = String.format("Lot#: %d, VIN: %s, Make: %s, Model: %s, Year: %d, Color: %s", this.lotNumber,
                this.vin, this.make, this.model, this.year, this.color);
        return out;
    }
     ...
     * @return whether or not the given car and this car are the same based on
     *         VIN
     */
