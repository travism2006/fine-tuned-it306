...
public final class Sedan extends Vehicle {
   ...
   * @param mayConvert
   *          the boolean saying whether or not this converts
   */
   ...
   *          the boolean saying whether or not this converts
   */
  public Sedan(Customer someCust, String makeN, String modelN, CarColors colorN, int yearN, String someVIN,
      boolean mayConvert) {
   ...
   * 
   * @param someStatus
   *          value that is binary - either is or is not true
   */
