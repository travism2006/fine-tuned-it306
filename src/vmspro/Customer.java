...
public class Customer implements VMSPro_Standard_Behavior {
    ...
    public String toString() {
        String out = String.format("Customer ID: %d, Full Name: %s %s, Primary Address: %s", this.custID,
                this.firstName, this.lastName, this.address.toString());
        out += "\n";
        for (Vehicle car : carListMap.values()) {
            if (car instanceof Sedan) {
                Sedan sidsSedan = (Sedan) car;
                out += String.format("Lot#: %d, Car VIN: %s, Car Type: Sedan,", sidsSedan.getLotNumber(),
                        sidsSedan.getVin());
                ...
                out += String.format("Lot#: %d, Car VIN: %s, Car Type: Van,", vincentsVan.getLotNumber(),
                        vincentsVan.getVin());
            }
        }
        return out;
     ...
     * the IDs are identical, then it is said that the given object is
