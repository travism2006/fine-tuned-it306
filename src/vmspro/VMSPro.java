...
public final class VMSPro {
    ...
    /**
     * Returns the first customer that has a matching id. Primarily used by GUI
     * to identify customers against input jtextfields.
     * 
     * @param someID
    ...
    /**
     * Returns the first vehicle that has a matching VIN. Primarily used by GUI
     * to identify cars against input jtextfields.
     * 
     * @param someVIN
     ...
     * each vehicle instance that has a specific make value since it is possible
     * for one 'make' value to be seen several times across different vehicle
     * instances.</i>
     * 
     ...
     * containing null value, or is equivalent to an empty string. Passing these
     * 3 tests, the string is said to be 'valid' and 'unique'.
     * 
     * @param someStr
