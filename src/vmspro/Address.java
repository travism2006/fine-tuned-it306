...
public final class Address {
   ...
   * @param someCity
   * @param someState
   *          the state where this address is located in
   * @param someZip
  ...
  /**
   * Specifies the house number or apartment number on a street. Validates for
   * null attributes and pointers throug static methods in VMS Pro.
   * 
   * @param someStreet
   *          the street address with apt. # or house number
  ...
  /**
   * Validates for null attributes and pointers throug static methods in VMS
   * Pro. Will attempt to assign to the city field if not null.
   * 
   * @param someCity
   *          the city to be assigned for the respective field
   * @return whether or not the assigning of data worked
   */
  ...
  /**
   * Validates for null attributes and pointers throug static methods in VMS
   * Pro. Will attempt to assign to the state field if not null.
   * 
   * @param someState
   *          the state to be assigned for the respective field
   * @return whether or not the assigning of data worked
   */
  ...
  public String toString() {
    String out = String.format("Street Address: %s, City: %s, State: %s, Zipcode: %d", this.streetAddress, this.city,
