...
public final class Van extends Vehicle {
   ...
   * @param someCargo
   *          the amount of cargo space in the van
   */
   ...
   *          the amount of cargo space in the van
   */
  public Van(Customer someCust, String makeN, String modelN, CarColors colorN, int yearN, String someVIN,
      double someCargo) {
