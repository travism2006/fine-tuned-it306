    ...
    public vmsproGUI() {
        ...
        groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
                ...
                .addGroup(groupLayout.createSequentialGroup().addGap(75).addGroup(groupLayout
                        .createParallelGroup(Alignment.LEADING).addComponent(lblReports)
        ...
        groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
                .addGroup(groupLayout.createSequentialGroup().addGap(57)
                        ...
                        .addGroup(groupLayout.createParallelGroup(Alignment.BASELINE).addComponent(btnAllVehicles)
                                .addComponent(btnAllCustomers).addComponent(btnTypesOfVehicles).addComponent(
                                        btnUnlinkedVehicles)
        ...
        gl_carPanel
                .setVerticalGroup(gl_carPanel.createParallelGroup(Alignment.LEADING)
                        .addGroup(gl_carPanel.createSequentialGroup()
                                .addGroup(gl_carPanel.createParallelGroup(Alignment.BASELINE)
                                        .addComponent(lblVehicles, GroupLayout.PREFERRED_SIZE, 29,
