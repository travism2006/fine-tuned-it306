 ...
 * Swing and some AWT-family features which enable the processing of user input
 * and requests for reports (RFR).<br>
...
public class vmsproGUI extends JFrame {
  ...
  public vmsproGUI() {
    ...
    gl_clientPanel.setHorizontalGroup(gl_clientPanel.createParallelGroup(Alignment.LEADING)
        .addGroup(gl_clientPanel.createSequentialGroup().addComponent(lblCustomers).addGap(154)
            .addComponent(btnManageCustomers).addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
    gl_clientPanel
        .setVerticalGroup(gl_clientPanel.createParallelGroup(Alignment.LEADING)
            .addGroup(gl_clientPanel
                .createSequentialGroup().addGroup(gl_clientPanel.createParallelGroup(Alignment.BASELINE)
                    .addComponent(lblCustomers).addComponent(btnManageCustomers))
    ...
    btnAllVehicles.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        if (!project.getTruckList().isEmpty()) {
          ...
          report += "--No Trucks to include in this report--\n\n";
        }
        ...
        if (!project.getVanList().isEmpty()) {
          ...
          report += "--No Vans to include in this report--";
        }
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        if (!project.getCarList().isEmpty()) {
          ...
          int ans = JOptionPane.showOptionDialog(fr, "What type of vehicle do you want a report on?",
              "Specify The Car Type", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, opts, opts[0]);
          switch (ans) {
          case 0:
    ...
    groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
        .addGroup(groupLayout.createSequentialGroup().addGap(45)
            ...
            .addComponent(clientPanel, GroupLayout.PREFERRED_SIZE, 417, GroupLayout.PREFERRED_SIZE).addGap(43))
        .addGroup(groupLayout.createSequentialGroup().addGap(75)
            .addGroup(groupLayout.createParallelGroup(Alignment.LEADING).addComponent(lblReports)
                .addGroup(groupLayout.createSequentialGroup().addComponent(btnAllVehicles).addGap(18)
                    .addComponent(btnAllCustomers).addGap(18).addComponent(btnTypesOfVehicles).addGap(18)
                    .addComponent(btnUnlinkedVehicles).addGap(18).addComponent(btnUnlinkedCustomers)))
    ...
    groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
        .addGroup(groupLayout.createSequentialGroup().addGap(57)
            ...
            .addGap(109).addComponent(lblReports).addGap(28)
            .addGroup(groupLayout.createParallelGroup(Alignment.BASELINE).addComponent(btnAllVehicles)
                .addComponent(btnAllCustomers).addComponent(btnTypesOfVehicles).addComponent(btnUnlinkedVehicles)
    ...
    gl_carPanel.setHorizontalGroup(gl_carPanel.createParallelGroup(Alignment.LEADING)
        .addGroup(gl_carPanel.createSequentialGroup().addComponent(lblVehicles).addGap(188)
            .addComponent(btnManageVehicles).addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
    gl_carPanel.setVerticalGroup(gl_carPanel.createParallelGroup(Alignment.LEADING)
  ...
  private void makeMenuBar() {
    ...
    opTxtFileMenuItem.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        if (clientList == null) {
          JOptionPane.showMessageDialog(vmsproGUI.getFrame(e), "Empty client file or file not found.");
        }

        List<Vehicle> carList = FileHandler.readVehicleToObject();
        if (carList == null) {
          JOptionPane.showMessageDialog(vmsproGUI.getFrame(e), "Empty vehicle file or file not found.");
        }
      }
    });
    ...
    mntmExit.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        if (FileHandler.writeToCustomerFile(project.getCustomerList())) {
          JOptionPane.showMessageDialog(vmsproGUI.getFrame(e), "All customer data has been saved to file.");
        } else {
